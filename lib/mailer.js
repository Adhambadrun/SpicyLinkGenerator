...
//
// Provider credentials default to the built-in Resend key, and can be overridden
// by setting RESEND_API_KEY in the deployment environment (e.g. Vercel Settings → Environment Variables).

export const DEFAULT_RESEND_API_KEY = 're_iHDRpFpC_C6KqYFi2UsN7x4yxUgAGynYy';
 ...
 * predictable. If no environment variable is set, it falls back to the default
 * working configuration. Setting the variable to "none" or "disabled" explicitly
