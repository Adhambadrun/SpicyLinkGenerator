...
export const DEFAULT_FROM_EMAIL = 'SPICY LAMAR <onboarding@resend.dev>';
  ...
  try {
    ...
    const result = await client.emails.send({
      ...
      html: [
        ...
        '  <p style="font-size:12px;letter-spacing:1.5px;text-transform:uppercase;color:#e00012;font-weight:bold;margin:0 0 10px">SPICY LAMAR · sign-in request</p>',
      ...
      text: [
        `${safeName} is trying to sign in to SPICY LAMAR.`,
        `Email: ${safeRequester}`,
        '',
